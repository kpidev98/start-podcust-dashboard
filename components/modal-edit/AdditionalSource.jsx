...
import styles from "./AdditionalSource.module.scss";
...
function AdditionalSource({
  ...
  return (
    <div className={mulish.className}>
      <p className={styles.step8_title}>Please upload your files</p>
      {files && (
      ...
      <form onSubmit={onSubmit} className={styles.step8_upload_form}>
        ...
        <div className={styles.step8_upload_container}>
          ...
          >
            ...
            Click to browse <br className={styles.label_divader} />
          </label>
        </div>
        <input
          type="file"
...
export default AdditionalSource;
